...
- Музыка: «включи музыку» (Spotify / Яндекс Музыка / системный плеер + play), пауза, следующий/предыдущий трек
...
- Два уровня понимания команд:
  ...
  - локальная LLM Needle 3 через Cactus runtime + fallback-правила
